...
<div class="panel panel-default">
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<td>{{ $x++}}</td>
				<td>{{ $jadwal_matakuliah->mahasiswa->nama_mahasiswa or 'nama Kosong' }}</td>
				...
				<td>
					<div class="btn-group" role="group">
						<a href="{{url('jadwal_matakuliah/edit/'.$jadwal_matakuliah->id)}}" class="btn btn-info btn-xs" data-toogle="tooltip" data-placement="top" title="Ubah"><i class="fa fa-pencil"></i></a>
						<a href="{{url('jadwal_matakuliah/lihat/'.$jadwal_matakuliah->id)}}" class="btn btn-warning btn-xs" data-toogle="tooltip" data-placement="top" title="Lihat"><i class="fa fa-eye"></i></a>
