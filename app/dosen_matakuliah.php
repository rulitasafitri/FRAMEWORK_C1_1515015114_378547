...
class dosen_matakuliah extends Model
{
 ...
 {
 	return $this->hasMany(jadwal_matakuliah::class,'dosen_matakuliah');//fungsi jadwal_matakuliah memilikii nilai return hasMany pada class eloquent dengan mengambil dosen matakuliah sebagai primary key, model dosen_matakulia dan model jadwal_matakuliah berrelasi dengan kardinalitas one to many
 }
}
